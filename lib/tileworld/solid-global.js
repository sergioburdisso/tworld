...
var _ACTION = {WEST:0, EAST:1, NORTH:2, SOUTH:3, NONE:4, CONSOLE_CLEAR:5, ERROR:"error:", MESSAGE:"message:"};
var _GRID_CELL = {EMPTY:" ", TILE:"T", OBSTACLE:"#", HOLE_CELL:1, AGENT:"A", BATTERY_CHARGER:"C"};
var _PERCEPT = {START: "start", END : "end", READY_FOR_NEXT_ACTION: "ready_for_next_action"}
