...
cycle)
*/
importScripts('solid-global.js', 'solid-general-settings.js', 'solid-core.js'); 
...
function alert(msg){ returnAction(_ACTION.MESSAGE + msg); }
var console = {};
console.error = function(msg){ returnAction(_ACTION.ERROR + msg); }
