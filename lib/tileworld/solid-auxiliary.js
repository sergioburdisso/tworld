...
//Object.nextProperty = function(prop){ <- JQuery crashes!
...
function updateScreenResolution(height, width){
	try{
	$("#tw-root").css("width", _RENDER_WIDTH+"px").css("height", _RENDER_HEIGHT+"px");
	$("#tileworld").prop("width", _RENDER_WIDTH).prop("height", _RENDER_HEIGHT);
	}catch(e){}
}
function fullWindowRender(){
	$("#tw-root").css("width", "100%").css("height", "100%");
}
