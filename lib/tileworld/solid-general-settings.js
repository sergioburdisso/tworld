...
_ROBS[1].CONTROLLED_BY_AI = false;
if (_ROBS[_NUMBER_OF_ROBS]){
_ROBS[2].NAME = "NOTE_II";
...
var _TEAMS = [
	{NAME:"", MEMBERS:[0]},
	{NAME:"Los petes", MEMBERS:[1]},
	/*{NAME:"Los guachos", MEMBERS:[2]},
	{NAME:"Los no se", MEMBERS:[3]}*/
	];

var _TIME_LIMIT	= 1*60;//seconds
