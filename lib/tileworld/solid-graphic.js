		...
		function display(CL_Scene, currentTime) {
			...
			//region fps calculation (how many time does it take the browser to render 60 frames?)
				...
				if (this.framesCounter == 0){
					...
					_self.Environment.Costs.moves = _self.Rob.autoCalculateSpeed(_self.currentFPS);
					_self.Environment.Costs.moves = (Math.ceil(_FloorCellSize/_self.Environment.Costs.moves)/_self.currentFPS).toFixed(2)*100;
