			...
			//region Public
				//region Getters And Setters
					...
					this.setBatteryChargerLocation = function(row, column){
						...
						_CL_Floor[row][column][1].getMaterial(0).Tex1 = _CL_Engine.getTextureManager().getTexture("./copperlichtdata/tileCell_Diffuse_Map_tp.png", true);
						_CL_Floor[row][column][0].getMaterial(0).Tex1 = _CL_Engine.getTextureManager().getTexture("./copperlichtdata/tileCell_Diffuse_Map_tp.png", true);;
					}
