...
//region "Knobs" (The knob settings control the evolution of a Tileworld simulation)
	...
	Tileworld.NumberOfObstacles = 4; // how many obstacles are going to appear each time?
	...
	Tileworld.Dynamism = 16; // time in seconds (the rate at which new holes appear and disappear)
	...
	//--------------------------------------------------------------------------------------> utilityFillCell
	Tileworld.valueOfCellHoleFilled = function(sizeSoFar) {return 2;}// menor que 10 (que el valor de tapar uno de uno completo)
