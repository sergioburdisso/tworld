...
function Tileworld(args) {
	...
	//region Methods
		//region Public Methods
			...
			this.perseptionFunction = function(environment) /*returns a JSON*/{
				this.Perseption = {
					grid: environment.Grid,
					agentPosition: [0,0],
					/*batery : 100,*/
					listOfHoles: [{id: , cells: [], size: []/*, lifeTime: segs*/}, ...],
					listOfTiles: [[0,0], ...]
				}
				/*console.log("#\t#\t#\t#\t#\t#\t#\t#\t#\t#\t#\t#");
				for (var i=0; i < environment.Grid.length; ++i)
					console.log("#\t"+environment.Grid[i].join("\t")+"\t#");
				console.log("#\t#\t#\t#\t#\t#\t#\t#\t#\t#\t#\t#");*/
				console.log(
					JSON.stringify(
						this.Perseption
