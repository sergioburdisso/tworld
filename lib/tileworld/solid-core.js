...
//region "Knobs" (The knob settings control the evolution of a Tileworld simulation)
	...
	Tileworld.HoleSize = 1;//3;
	Tileworld.HolesSize_UncertaintyThreshold = 1;
	Tileworld.NumberOfHoles = 2;//4; // how many holes are going to appear each time?
	Tileworld.NumberOfHoles_UncertaintyThreshold = 0.5;

	Tileworld.NumberOfObstacles =0;//5; // how many obstacles are going to appear each time?
