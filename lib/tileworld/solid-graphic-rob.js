...
function GraphicRob(CLNode, graphicTileWorld, index){
	...
	//region Methods
		//region Static methods
			...
			GraphicRob.AutocalculateSpeed = function(currentFPS){
					GraphicRob._WalkCurrentSpeed = _ROB_WALKSPEED*(_FPS/currentFPS);
				...
				if (_currentAnimation != ANIMATION.None){
					...
					switch(_currentAnimation){
						...
						case  ANIMATION.CantDoThat: //does he have to say "I can't do that" to the user?
							...
							if (_turnAroundFlag && isCurrentAimation(CL_ANIMATION.CantWhileStanding))
	...
	//region Constructor Logic --------------------------------------------------------------> Constructor Begin
		...
		//_ROB_WALKSPEED guard
		if (_ROB_WALKSPEED > 5) _ROB_WALKSPEED = 5;//5 = _FloorCellSize/2
		GraphicRob._WalkCurrentSpeed = _ROB_WALKSPEED;
