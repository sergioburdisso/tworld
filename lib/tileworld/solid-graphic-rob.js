	...
	//region Methods
		...
		//region Private
			...
			function RobStartsThinkingAboutNextAction(){
				...
				_programAgent.postMessage( _abstractLevel.perseptionFunction(_environment) /*total o parcial 2 -> 2+r+2 x 2+r+2*/);
			}
			...
			//region Animation Functions
				...
				function Animation_stopWalking(){
					...
					_currentAnimation = ANIMATION.None;
_abstractLevel.perseptionFunction(_environment); // BORRAR
