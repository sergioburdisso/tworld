...
importScript(
	...
	"_CONTROLLED_BY_AI[0] && _SOCKET_PROGRAM_AGENT && _SOCKET_OUTPUT_FORMAT == _PERCEPT_FORMAT.XML"
);
importScript(
	"./lib/util/sprintf.min.js",
	/*provided that the following conditions are satisfied*/
	"_CONTROLLED_BY_AI[0] && _SOCKET_PROGRAM_AGENT && _SOCKET_OUTPUT_FORMAT != _PERCEPT_FORMAT.JSON"
);
