...
$text.main.agplLicense[_LANGUAGES.ENGLISH] = '<a href="https://github.com/sergioburdisso/tworld" target="_blank">This project</a> is free software <sup>[<a href="https://github.com/sergioburdisso/tworld/archive/v'+localStorage.version+'.zip" target="_blank">download zip</a>]</sup>, you can redistribute it and/or modify it under the terms of the GNU AGPL License <a rel="license" target="_blank" href="http://www.gnu.org/licenses/agpl-3.0.html">(Affero General Public License)</a>';
