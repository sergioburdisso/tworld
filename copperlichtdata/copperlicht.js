 ...
 *
 * NOTE: this is a modified and optimized version of the original CopperLicht file.
 *       Changes were made by Sergio Burdisso (sergio.burdisso@gmail.com), mainly
 *       because the Garbage Collector consumed 36% of the total runtime, after changes
...
CL3D.CopperLicht.prototype.registerEventHandlers = function () {
    ...
    var b = document;// this.MainElement;
    if (b != null) {
